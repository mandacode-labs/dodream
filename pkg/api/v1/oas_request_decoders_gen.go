...
func (s *Server) decodeCreateDeckRequest(r *http.Request) (
...
func (s *Server) decodeCreateStudyEventRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request CreateStudyEventRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeUpdateDeckRequest(r *http.Request) (
