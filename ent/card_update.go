...
func (_u *CardUpdate) AddNotebookCardIDs(ids ...string) *CardUpdate {
	_u.mutation.AddNotebookCardIDs(ids...)
	return _u
}

// AddNotebookCards adds the "notebook_cards" edges to the NotebookCard entity.
func (_u *CardUpdate) AddNotebookCards(v ...*NotebookCard) *CardUpdate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddNotebookCardIDs adds the "notebook_cards" edge to the NotebookCard entity by IDs.
func (_u *CardUpdateOne) AddNotebookCardIDs(ids ...string) *CardUpdateOne {
	_u.mutation.AddNotebookCardIDs(ids...)
	return _u
}

// AddNotebookCards adds the "notebook_cards" edges to the NotebookCard entity.
func (_u *CardUpdateOne) AddNotebookCards(v ...*NotebookCard) *CardUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearNotebookCards clears all "notebook_cards" edges to the NotebookCard entity.
func (_u *CardUpdateOne) ClearNotebookCards() *CardUpdateOne {
	_u.mutation.ClearNotebookCards()
	return _u
}

// RemoveNotebookCardIDs removes the "notebook_cards" edge to NotebookCard entities by IDs.
func (_u *CardUpdateOne) RemoveNotebookCardIDs(ids ...string) *CardUpdateOne {
	_u.mutation.RemoveNotebookCardIDs(ids...)
	return _u
}

// RemoveNotebookCards removes "notebook_cards" edges to NotebookCard entities.
func (_u *CardUpdateOne) RemoveNotebookCards(v ...*NotebookCard) *CardUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
