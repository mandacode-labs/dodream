...
// GRPCServer implements the gRPC EngineService.
type GRPCServer struct {
	pb.UnimplementedEngineServiceServer
	processor *EventProcessor
}

// NewGRPCServer creates a new gRPC server for the engine.
func NewGRPCServer(processor *EventProcessor) *GRPCServer {
	return &GRPCServer{processor: processor}
}

// GetCardState returns the current state for a user-card pair.
func (s *GRPCServer) GetCardState(ctx context.Context, req *pb.GetCardStateRequest) (*pb.CardStateResponse, error) {
...
func (s *GRPCServer) GetNextCards(ctx context.Context, req *pb.GetNextCardsRequest) (*pb.NextCardsResponse, error) {
...
func StartGRPCServer(addr string, srv *GRPCServer) (*grpc.Server, error) {
